...
<body>
	...
	<div class=main>
		<form id="user_login" action="" method="post" onsubmit="return checkMust(['sex','age','profession']);">
			...
			<p class=sub_sub_title id=sex_error><b class=blue>1、性别：</b><em class=red>*必填</em>&nbsp;<label><input type=radio name=sex value=1 />男</label>&nbsp;<label><input type=radio name=sex value=2 />女</label></p>
			<p class=sub_sub_title id=age_error><b class=blue>2、年龄：</b><em class=red>*必填</em>&nbsp;<label><input type=radio name=age value=1 />25岁以下</label>&nbsp;<label><input type=radio name=age value=2 />26到60岁</label>&nbsp;<label><input type=radio name=age value=3 />61岁以上</label></p>
			<p class=sub_sub_title id=profession_error><b class=blue>3、职业：</b><em class=red>*必填</em>&nbsp;<label><input type=radio name=profession value=1 />行政机关</label>&nbsp;<label><input type=radio name=profession value=2 />事业单位</label>&nbsp;<label><input type=radio name=profession value=3 />企业</label>&nbsp;<label><input type=radio name=profession value=4 />自由职业者</label>&nbsp;<label><input type=radio name=profession value=5 />学生</label>&nbsp;<label><input type=radio name=profession value=6 />其他</label></p>
			<br>
